...
class TestSanity {
    ...
    fun setupDesiredCapabilities(){
        ...
        capabilities.setCapability("appium:deviceNam", "emulator-5554")
        ...
        capabilities.setCapability("appium:app","/Users/nursektiwaskitha/Documents/mobile automation sleekflow/app/todoist-v11422.apk")
